...
#include "fire_mario/model.inc.c"
#include "fire_flower/model.inc.c"
#include "waluigi/model.inc.c"

#include "small_chain_chomp/model.inc.c"
#include "lois/model.inc.c"
#include "fat_plant/model.inc.c"
#include "fat_plant/anims/data.inc.c"
#include "fat_plant/anims/table.inc.c"