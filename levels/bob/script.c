...
static const LevelScript script_func_local_2[] = {
    ...
    OBJECT          (/*model*/ MODEL_SMALL_CHAIN_CHOMP,           /*pos*/  3400,  770,  6500, /*angle*/ 0, 0, 0,   /*behParam*/ 0x00010000, /*beh*/ bhvSmallChainChomp),
    OBJECT          (/*model*/ MODEL_FAT_PIRANHA,           /*pos*/  -342,   400,  5433, /*angle*/ 0, 0, 0,   /*behParam*/ 0x00010000, /*beh*/ bhvFatPlant),
    RETURN(),
};
