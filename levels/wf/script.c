...
static const LevelScript script_func_local_1[] = {
    ...
    OBJECT(/*model*/ MODEL_LEVEL_GEOMETRY_0D, /*pos*/  3405, 1664, -1791, /*angle*/ 0, 0, 0, /*behParam*/ 0x00000000, /*beh*/ bhvStaticObject),
    OBJECT(/*model*/ MODEL_LEVEL_GEOMETRY_09, /*pos*/  3840,    0, -2303, /*angle*/ 0, 0, 0, /*behParam*/ 0x00000000, /*beh*/ bhvStaticObject),
    OBJECT(/*model*/ MODEL_LEVEL_GEOMETRY_09, /*pos*/  3840,    0, -1279, /*angle*/ 0, 0, 0, /*behParam*/ 0x00000000, /*beh*/ bhvStaticObject),
...
static const LevelScript script_func_local_2[] = {
    ...
    OBJECT_WITH_ACTS(/*model*/ MODEL_FIRE_FLOWER,                         /*pos*/  -384, 3584,     6, /*angle*/ 0,   0, 0, /*behParam*/ 0x00000000, /*beh*/ bhv1Up,            /*acts*/ ACT_2 | ACT_3 | ACT_4 | ACT_5 | ACT_6),
...
const LevelScript level_wf_entry[] = {
    ...
    ALLOC_LEVEL_POOL(),
    MARIO(/*model*/ MODEL_LUIGI, /*behParam*/ 0x00000001, /*beh*/ bhvMario),
    ...
    LOAD_MODEL_FROM_GEO(MODEL_LEVEL_GEOMETRY_0D,                wf_geo_000820),
    LOAD_MODEL_FROM_GEO(MODEL_LEVEL_GEOMETRY_09,                wf_geo_000860),
    ...
    AREA(/*index*/ 1, wf_geo_000BF8),
        ...
        SET_BACKGROUND_MUSIC(/*settingsPreset*/ 0x0005, /*seq*/ SEQ_EVENT_CUTSCENE_LAKITU),
