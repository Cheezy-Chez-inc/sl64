...
DEFINE_LEVEL("COURSE ? CASTLE", LEVEL_C, COURSE_C, C, generic, 20000, 0x00, 0x00, 0x00, _, sCamC) 
...
DEFINE_LEVEL("OW1 C GROUNDS", LEVEL_CASTLE_GROUNDS, COURSE_NONE, castle_grounds, outside, 20000, 0x00, 0x00, 0x00, _, _) 
...
DEFINE_LEVEL("COURSE 2 WF", LEVEL_WF, COURSE_WF, wf, grass, 20000, 0x00, 0x00, 0x00, _, _) 
