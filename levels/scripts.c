...
const LevelScript level_main_scripts_entry[] = {
    ...
    LOAD_MODEL_FROM_GEO(MODEL_FIRE_LUIGI,              fire_mario_geo),
    ...
    LOAD_MODEL_FROM_GEO(MODEL_SMALL_CHAIN_CHOMP,               small_chain_chomp_geo),
    ...
    LOAD_MODEL_FROM_GEO(MODEL_LUIGIS_WINGED_METAL_CAP, marios_winged_metal_cap_geo),
    LOAD_MODEL_FROM_GEO(MODEL_LUIGIS_METAL_CAP,        marios_metal_cap_geo),
    LOAD_MODEL_FROM_GEO(MODEL_LUIGIS_WING_CAP,         marios_wing_cap_geo),
    LOAD_MODEL_FROM_GEO(MODEL_LUIGIS_CAP,              marios_cap_geo),
    LOAD_MODEL_FROM_GEO(MODEL_LUIGIS_WINGED_METAL_CAP, marios_winged_metal_cap_geo),
    LOAD_MODEL_FROM_GEO(MODEL_LUIGIS_METAL_CAP,        marios_metal_cap_geo),
    LOAD_MODEL_FROM_GEO(MODEL_LUIGIS_WING_CAP,         marios_wing_cap_geo),
    LOAD_MODEL_FROM_GEO(MODEL_LUIGIS_CAP,              marios_cap_geo),
    LOAD_MODEL_FROM_GEO(MODEL_FAT_PIRANHA,             fat_plant_geo), // repeated
...
const LevelScript script_func_global_16[] = {
    ...
    LOAD_MODEL_FROM_GEO(MODEL_LAKITU,                  lakitu_cameraman_geo),
    LOAD_MODEL_FROM_GEO(MODEL_TOAD,                    toad_geo),
    LOAD_MODEL_FROM_GEO(MODEL_TOADETTE,                toadette_geo),
    RETURN(),
};
