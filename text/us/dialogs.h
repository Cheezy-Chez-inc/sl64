...
Oh!, Luigi! i see you've\n\
finally made it! I was\n\
worried you wouldn't\n\
show up! Your brother,\n\
Mario! Nobody has seen\n\
him at all for the past\n\
week! I think he might've\n\
been kidnapped! Try going\n\
in his castle, you might find\n\
something! Go on! Why are\n\
you still here!"))

DEFINE_DIALOG(DIALOG_001, 1, 4, 95, 200, _("\
i sure love guarding\n\
marios castle!"))
