...
struct ExclamationBoxContents sExclamationBoxContents[] = {
    { EXCLAMATION_BOX_BP_WING_CAP,         0, 0, MODEL_LUIGIS_WING_CAP,  bhvWingCap               },
    { EXCLAMATION_BOX_BP_METAL_CAP,        0, 0, MODEL_LUIGIS_METAL_CAP, bhvMetalCap              },
    { EXCLAMATION_BOX_BP_VANISH_CAP,       0, 0, MODEL_LUIGIS_CAP,       bhvVanishCap             },
